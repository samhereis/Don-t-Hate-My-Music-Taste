...
namespace Gameplay
{
    ...
    {
        [SerializeField] private GameObject B, NB, M, H;
        [SerializeField] private List<GameObject> Prefs;
        private List<Vector2> _dickTionary = new List<Vector2>()
        {
