...
{
    [DisallowMultipleComponent] public class UIWindowEditorHelper : MonoBehaviour
    {
    ...
    [CustomEditor(typeof(UIWindowEditorHelper))] public class UIWindowEditorHelperEditor : Editor
    {
