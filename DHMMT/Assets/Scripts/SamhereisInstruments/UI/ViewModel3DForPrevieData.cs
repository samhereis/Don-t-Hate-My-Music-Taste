...
namespace Gameplay.UI.Menu.Canvas
{
    public class ViewModel3DForPrevieData : MonoBehaviour
    {
        ...
        [SerializeField] private AllPlayersHolder _allPlayers;
        ...
        private void OnEnable()
        {
            ...
            View(_allPlayers.currentPlayer);
        }
        ...
        {
            View(_allPlayers.GetNextPlayer(_currentPlayerCard), -1);
        }

        public void ViewPrevious()
        {
            View(_allPlayers.GetPrevuiusPlayer(_currentPlayerCard), 1);
        }
        ...
        {
            _allPlayers.SelectPlayer(_currentPlayerCard);
        ...
        {
            if (_allPlayers == null) _allPlayers = await AddressablesHelper.GetAssetAsync<AllPlayersHolder>("AllPlayersHolder");
