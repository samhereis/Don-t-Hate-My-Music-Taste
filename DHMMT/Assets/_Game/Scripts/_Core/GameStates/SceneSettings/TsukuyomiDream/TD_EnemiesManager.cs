...
{
    public class TD_EnemiesManager : GameState_EnemiesManagerBase, ISubscribesToEvents, INeedDependencyInjection
    {
        ...
        public TD_EnemiesManager(TD_SceneManager eFH_SceneManager)
        {
