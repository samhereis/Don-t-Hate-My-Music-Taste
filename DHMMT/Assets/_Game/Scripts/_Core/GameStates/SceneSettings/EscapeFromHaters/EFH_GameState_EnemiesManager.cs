...
{
    public class EFH_GameState_EnemiesManager : GameState_EnemiesManagerBase, IInitializable<PlayerIdentifier>, INeedDependencyInjection
    {
        ...
        public EFH_GameState_EnemiesManager(EFH_SceneManager eFH_SceneManager)
        {
        ...
        public void Initialize(PlayerIdentifier playerIdentifier)
        {
            ...
            { 
                _playerIdentifier = Object.FindFirstObjectByType<PlayerIdentifier>(FindObjectsInactive.Include); 
            }
