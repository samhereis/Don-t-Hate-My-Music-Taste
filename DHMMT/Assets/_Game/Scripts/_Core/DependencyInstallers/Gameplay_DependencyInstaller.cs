...
namespace DependencyInjection
{
    public class Gameplay_DependencyInstaller : DependencyInstallerBase
    {
        ...
        private DataSignal<Exit_Identifier> onExitFound = new(DataSignal_ConstStrings.onExitFound);
        private DataSignal<GameplayStatus> onGameplayStatusChanged = new(DataSignal_ConstStrings.onGameplayStatusChaned);
        ...
        private void InjectSignals()
        {
            ...
            DependencyContext.diBox.Add<DataSignal<Exit_Identifier>>(onExitFound, DataSignal_ConstStrings.onExitFound);
            DependencyContext.diBox.Add<DataSignal<GameplayStatus>>(onGameplayStatusChanged, DataSignal_ConstStrings.onGameplayStatusChaned);
