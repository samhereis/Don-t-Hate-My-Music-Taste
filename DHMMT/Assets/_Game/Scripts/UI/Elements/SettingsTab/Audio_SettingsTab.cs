...
namespace UI.Elements.SettingsTab
{
    public class Audio_SettingsTab : SettingsTabBase
    {
        ...
        {
            _audioMixer.data.SetFloat(Savables_ConstStrings.masterVolume_Settings, GetVolume(_masterVolume_Settings));
            _audioMixer.data.SetFloat(Savables_ConstStrings.musicVolume_Settings, GetVolume(_musicVolume_Settings));
            _audioMixer.data.SetFloat(Savables_ConstStrings.effectsVolume_Settings, GetVolume(_effectsVolume_Settings));
        }
